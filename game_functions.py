...
def fire_bullet(ai_settings, screen, ship, bullets):
    # Fire a bullet if limiet not reached yet.
...
def update_bullets(ai_settings, screen, stats, sb, ship, aliens, bullets):
        ...
        # Get rid of bullets thad have disappeared
...
def check_aliens_bottom(ai_settings, screen, stats, sb, ship, aliens,
        bullets):
    """Check if any aliens have reached the borrm of the screen."""
...
def save_high_score(stats):
    return
   # """Save the high score in archive."""
   # #d = {"Name": input("Name: "), "Score": str(stats.high_score)}
   # with open archive
